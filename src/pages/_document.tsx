            ...
            <Html lang={"en"}>
                <Head>
                    ...
                    <meta name="description"
                          content="QR Calendar - Create and Share events to calendars using QR codes"/>
                ...
                <body>
                <script
                    dangerouslySetInnerHTML={{__html: `document.body.dataset.theme = window.localStorage.getItem('theme') || "light"`}}/>
                <Main/>
                <NextScript/>
                </body>
            </Html>
